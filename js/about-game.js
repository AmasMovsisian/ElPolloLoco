const texts = {
    en: {
        ...
        credits: "This game was created as a coding project. For more details about the provider, privacy, and legal information, check out our ",
    ...
    de: {
        ...
        description: "Dieses Jump-and-Run-Abenteuer ist inspiriert von Klassikern wie El Pollo Loco. Du steuerst den Charakter Pepe, erkundest die Welt, sammelst Items, besiegst Gegner und trittst einem mächtigen End-Boss gegenüber. Das Spiel bietet moderne Animationen, Soundeffekte und intuitive Steuerung für Desktop- und Mobilgeräte.",
        howToPlay: [
        ...
        credits: "Dieses Spiel wurde als Programmierprojekt entwickelt. Weitere Details zum Anbieter, Datenschutz und rechtliche Informationen findest du in unserer ",
    ...
    es: {
        ...
        credits: "Este juego fue creado como un proyecto de programación. Para más detalles sobre el proveedor, la privacidad y la información legal, consulta nuestra ",
