class BottleStatusBar extends DrawableObject {
  ...
  constructor() {
    ...
    this.setPercent(this.percentOfBottles);
  ...
  resolveImageIndex() {
    if (this.percentOfBottles >= 80) {
      return 5;
    } else if (this.percentOfBottles >= 60) {
      return 4;
    } else if (this.percentOfBottles >= 40) {
      return 3;
    } else if (this.percentOfBottles >= 20) {
      return 2;
    } else if (this.percentOfBottles > 0) {
      return 1;
    } else {
      return 0;
    }
